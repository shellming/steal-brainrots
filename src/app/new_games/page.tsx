...
import allGames from '@/data/meta/new_games.json';

export const metadata = {
    title: `New Games - ${MainName}`,
    description: 'Discover the latest additions to our game collection.',
    alternates: {
        canonical: '/new_games',
    },
};
    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-8">New Games</h1>
